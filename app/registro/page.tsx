        ...
        <div className="relative z-10 w-full max-w-3xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-400 text-lg">
              Asegura tu lugar en la experiencia que cambiará tu vida.
            </p>
          </div>
            ...
            {[1, 2, 3].map((s) => (
              <div
                ...
                className={`w-10 h-10 rounded-full flex items-center justify-center font-bold transition-all duration-300 ${
                  step >= s
                    ? "bg-secondary text-black scale-110 shadow-[0_0_15px_rgba(0,212,255,0.5)]"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-400">
                      Precio promocional hasta el 15 Dic
                    </p>
                  </div>
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-400">
                      Asegura tu lugar y paga el resto después
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <div className="bg-black/20 p-4 rounded-lg text-sm">
                      ...
                      <p className="font-mono bg-black/30 p-1 rounded mt-1 inline-block">
                        {formData.nombres || "TU_NOMBRE"}{" "}
                        {formData.apellidos || "APELLIDO"} -{" "}
                        {paymentType === "full" ? "COMPLETO" : "RESERVA"}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {step === 3 && (
              ...
              >
                ...
                <p className="text-gray-300 text-lg mb-8 max-w-md mx-auto">
                  Hemos recibido tus datos y comprobante. Validaremos tu
                  inscripción y te enviaremos la confirmación a tu WhatsApp en
                ...
                <div className="bg-[#161f32] p-6 rounded-xl max-w-sm mx-auto mb-8 border border-gray-700">
                  ...
                  <p className="text-2xl font-mono font-bold text-secondary tracking-widest">
                    RC-2025-{Math.floor(Math.random() * 1000)}
                  </p>
                </div>
                <button
