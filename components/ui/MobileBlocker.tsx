  ...
  return (
    <div className="fixed inset-0 z-[9000] bg-dark-bg flex flex-col items-center justify-center p-8 text-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center max-w-md">
        ...
        >
            <h1 className="text-4xl font-black mb-2 tracking-tighter text-white glitch-text" data-text="MOBILE">
                MOBILE
            </h1>
            ...
            <div className="bg-white/5 border border-white/10 p-6 rounded-xl backdrop-blur-sm mb-8">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                    Estamos preparando una experiencia móvil increíble para ti. 
                    Por ahora, por favor ingresa desde una computadora.
                </p>
            </div>
